...
exports.testingPneumatics = void 0;
...
function testingPneumatics(conversation, ctx, ticket) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (test[q]) {
            ...
            yield ctx.replyWithPhoto(new grammy_1.InputFile(`./src/tests/pneumatics/tickets/${q < 6 ? "common_questions" : "ticket_" + ticket}/img/img_${q}.png`));
...
exports.testingPneumatics = testingPneumatics;
